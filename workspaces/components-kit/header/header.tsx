    ...
    <>
      ...
      <aside
        className={classNames(
          ...
          " bg-wheal fixed top-0 left-0 bottom-0 right-0 w-[100vw]  z-10  transition-transform duration-300 supports-[-webkit-touch-callout: none]:h-[webkit-fill-available]"
        )}
      >
